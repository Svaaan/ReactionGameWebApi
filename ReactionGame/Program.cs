    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                // HighScoreRequest highScoreRequest2 = new();
                // highScoreRequest2.GetHighScore();
                ...
                else
                {
                    ...
                    HighScoreRequest highScoreRequest1 = new();
                    highscores = new(); //ingen bra lösning
                    highscores.AddRange(highScoreRequest1.GetTopTen().Result);
        ...
        {
            HighScoreRequest highScoreRequest = new();
            ...
            Highscore highscore = new Highscore
            {
                ...
                Time = time,
                ClickCreated = DateTime.Now
                   
            };

            highScoreRequest.PostRequest(highscore);
